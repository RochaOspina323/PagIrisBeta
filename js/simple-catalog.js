...
console.log('🚀 Simple Catalog cargado');
...
// FUNCIÓN UNIFICADA PARA EL CARRITO - FUNCIONA EN TODAS LAS PÁGINAS
function addToUnifiedCart(item) {
    // Usar el mismo localStorage que el carrito principal
    let cart = JSON.parse(localStorage.getItem('irisColombiaModaCart') || '[]');
    ...
    // Actualizar también el carrito principal si existe
...
// Función para actualizar contador de carrito unificado
function updateUnifiedCartCount() {
    const cart = JSON.parse(localStorage.getItem('irisColombiaModaCart') || '[]');
